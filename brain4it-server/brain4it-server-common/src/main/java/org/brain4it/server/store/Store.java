...
public interface Store
{
  ...
  List<Entry> listEntries(String path, String pattern) throws IOException;
    
  InputStream readEntry(String path) throws IOException;
  
  OutputStream writeEntry(String path) throws IOException;
  
  boolean deleteEntry(String path) throws IOException;
  
  String renameEntry(String path, String oldName, String newName) 
    throws IOException;
