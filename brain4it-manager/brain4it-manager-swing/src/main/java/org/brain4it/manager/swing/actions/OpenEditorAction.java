 ...
 * @author realor
 */
public class OpenEditorAction extends ManagerAction
{
  public OpenEditorAction(ManagerApp managerApp)
  {
    super(managerApp);
    putValue(AbstractAction.NAME, 
      managerApp.getLocalizedMessage("OpenEditor"));
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    managerApp.openEditor(module, path);
  }
