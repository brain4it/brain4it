...
public class CreateModuleAction extends ManagerAction
{
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if (dialog.isAccepted())
    {
      ...
      final String accessKey = dialog.getAccessKey();
      final BList metadata = dialog.getMetadata();
      ...
      client.createModule(moduleName, new Callback()
      {
        @Override
          ...
          final String resultString)
        {
          SwingUtilities.invokeLater(new Runnable()
          {
            ...
            public void run()
            {
              showResult(moduleName, accessKey, metadata, resultString);            
            }
          });
        }
  ...
  protected void showResult(final String moduleName, String accessKey, 
     BList metadata, String resultString)
  {
