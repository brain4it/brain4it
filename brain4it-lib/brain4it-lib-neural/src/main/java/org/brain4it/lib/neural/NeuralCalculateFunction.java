 ...
 * @author realor
 */
public class NeuralCalculateFunction extends NeuralFunction
{
  public NeuralCalculateFunction(NeuralLibrary library)
  {
    super(library);
  }
  ...
  public Object invoke(Context context, BList args) throws Exception
  {
    ...
    BList inputVector = (BList)context.evaluate(args.get(2));
    neuralNetwork.setInput(library.toDoubleArray(inputVector));
    neuralNetwork.calculate();
    return library.toBList(neuralNetwork.getOutput());
  }
}
