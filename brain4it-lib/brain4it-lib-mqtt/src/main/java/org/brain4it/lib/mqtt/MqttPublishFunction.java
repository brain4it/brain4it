 ...
 * @author realor
 */
public class MqttPublishFunction extends MqttFunction
{
  public MqttPublishFunction(MqttLibrary library)
  {
    super(library);
  }    
  ...
  public Object invoke(Context context, BList args) throws Exception
  {
    ...
    if (connection != null)
    {
      ...
      String payload = (String)context.evaluate(args.get(3));
      connection.publish(topic, payload.getBytes("UTF-8"), 
