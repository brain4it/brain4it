 ...
 * @author realor
 */
public class VoicesFunction implements Function
{
  @Override
  public Object invoke(Context context, BList args) throws Exception
  {
    ...
    // voices in use
    Set<String> voiceNames = TtsLibrary.getVoicesInUse().keySet();
    for (String voiceName : voiceNames)
    {
      if (voiceName.contains(TtsLibrary.VOICE_NAME_SEPARATOR))
      {
